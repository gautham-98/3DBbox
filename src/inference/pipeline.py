...
if __name__ == "__main__":
    ...
    SAMPLE = "8b061a8a-9915-11ee-9103-bbb8eae05561"

    PC_PATH = f"dataset/{SAMPLE}/pc.npy"
    RGB_PATH = f"dataset/{SAMPLE}/rgb.jpg"
    MASK_PATH = f"dataset/{SAMPLE}/mask.npy"
    BOX_PATH = f"dataset/{SAMPLE}/bbox3d.npy"
    CHECKPOINT = "checkpoints/checkpoint_epoch95.pth"
    IN_CHANNELS = 6
    DEVICE = "cpu"
