...
class LossLambda:
    ...
    schedule: List[float] = field(default_factory=lambda: [1])
    schedule_weight: List[float] = field(default_factory=lambda: [1])
    schedule_lambda: List[str] = field(default_factory=lambda: [])
